...
const StakeOkf: React.FC<StakeProps> = ({}) => {
  const tokenName = "OKF"
  ...
  const tokenBalance = useTokenBalance(contractAddresses.okf[1])
      ...
      <CardContent>
        <StyledCardContentInner>
          <StyledCardHeader>
            ...
            <Label text={`OKF Tokens Available`}/>
          </StyledCardHeader>
          <StyledCardActions>
            {!allowance.toNumber() ? (
              <Button
